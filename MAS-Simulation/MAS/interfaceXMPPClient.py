# NOTE: This code was taken from spade.xmpp_client and modified to not log

import ssl

from slixmpp import ClientXMPP as SlixmppClient
from slixmpp import Message as XMPPMessage  # used to export the message class
...
class XMPPClient(SlixmppClient):
    def __init__(self, jid, password, verify_security, auto_register):
        SlixmppClient.__init__(self, jid, password)
